...
public sealed class MainForm : Form
{
    ...
    private async Task InitialiseAsync()
    {
        ...
        // The counter PC is a machine the public can reach across a desk, and
        // this window is signed in as the shop. Turning off the context menu
        // closed one door and left the wider one open: F12 and Ctrl+Shift+I are
        // browser accelerator keys, so anyone could open devtools on an
        // owner-authenticated page, read the session out of storage or call the
        // bridge directly, and take over the shop account without knowing a
        // password. Both default to true in WebView2, so both have to be said
        // out loud.
        web.Settings.AreDevToolsEnabled = false;
        web.Settings.AreBrowserAcceleratorKeysEnabled = false;

        // Nothing here is a form worth remembering, and the engine offering to
        // save what staff type into a shop terminal is a leak with no upside.
